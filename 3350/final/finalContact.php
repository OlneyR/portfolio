...
<body>
	...
	<div id="container">
		<nav>
			<a href="index.htm"><img id="logo" src="logo.png"/></a>
			<ul>
			...
			<form id="feedback" method="post" action="" class="form-horizontal">
		        ...
		        <fieldset id="additionalComments">
		            ...
		            <p class="lead">
		                ...
		                <textarea name="comments" id="comments" cols="35" rows="8" class="input-block-level"><?php 
		                if (isset($missing)) {
		...
		<footer>
			...
			<ul>
				...
				<li><a href="finalPortfolio.htm">Portfolio</a></li>
				<li><a href="#">Contact</a></li>
				<li><a href="sitemap.png">Sitemap</a></li>
			</ul>
		</footer>
	</div>
